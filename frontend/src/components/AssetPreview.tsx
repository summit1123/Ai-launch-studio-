      ...
      <div className="assetGrid">
        ...
        >
          ...
          {assets.video_url ? (
            ...
            <div className="media-placeholder" style={{ background: "rgba(7, 18, 38, 0.74)", height: "220px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: "16px", border: "1px dashed var(--surface-border)", gap: "16px" }}>
              ...
              <div style={{ textAlign: "center" }}>
                <div style={{ color: "var(--ink)", fontSize: "1rem", fontWeight: 700, marginBottom: "4px" }}>Sora-2 영상 생성 대기 중</div>
        ...
        >
          ...
          {assets.poster_image_url ? (
            ...
            <div className="media-placeholder" style={{ background: "rgba(7, 18, 38, 0.74)", height: "220px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", borderRadius: "16px", border: "1px dashed var(--surface-border)", gap: "16px" }}>
              ...
              <div style={{ textAlign: "center" }}>
                <div style={{ color: "var(--ink)", fontSize: "1rem", fontWeight: 700, marginBottom: "4px" }}>히어로 포스터 생성 대기 중</div>
